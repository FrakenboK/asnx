...
func NewRootCmd() *cobra.Command {
	...
	cmd.Flags().StringVarP(&opts.OutputFile, "output", "o", "", "File to save output")

	// Search by Domain
	cmd.Flags().StringArrayVarP(&opts.Domains, "domains", "d", []string{}, "Domain names (usage: -d cr4.sh,yandex.ru or --domains domains.txt)")
